...
#nullable restore
    ...
    private abstract partial class CollectionIteratorBase<T> : IteratorBase<T>, ICollection<T>, IReadOnlyCollection<T>, ICollection
    {
    ...
    private abstract partial class ListIteratorBase<T> : CollectionIteratorBase<T>, IList<T>, IReadOnlyList<T>
    {
