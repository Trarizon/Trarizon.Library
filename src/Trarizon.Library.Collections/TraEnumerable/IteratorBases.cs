...
#nullable restore
    ...
    private abstract class CollectionIteratorBase<T> : IteratorBase<T>, ICollection<T>, IReadOnlyCollection<T>, ICollection
    {
        ...
        void ICollection<T>.Add(T item) => Throws.IteratorIsImmutable();
        void ICollection<T>.Clear() => Throws.IteratorIsImmutable();
        bool ICollection<T>.Remove(T item) { Throws.IteratorIsImmutable(); return default; }
    }
    ...
    private abstract class ListIteratorBase<T> : CollectionIteratorBase<T>, IList<T>, IReadOnlyList<T>
    {
        ...
        T IList<T>.this[int index] { get => this[index]; set => Throws.IteratorIsImmutable(); }
        ...
        void IList<T>.Insert(int index, T item) => Throws.IteratorIsImmutable();
        void IList<T>.RemoveAt(int index) => Throws.IteratorIsImmutable();
