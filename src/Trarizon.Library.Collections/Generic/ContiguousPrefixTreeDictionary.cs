...
public class ContiguousPrefixTreeDictionary<TKey, TValue> where TKey : notnull
{
    ...
    public ContiguousPrefixTreeDictionary()
    {
        _entries = [];
        _freeFirstIndex = -1;
    }

    public ContiguousPrefixTreeDictionary(IEqualityComparer<TKey> comparer)
    {
        _entries = [];
        _comparer = comparer;
        _freeFirstIndex = -1;
    ...
    {
        internal readonly ContiguousPrefixTreeDictionary<TKey, TValue> _tree;
        internal readonly int _index;

        internal Node(ContiguousPrefixTreeDictionary<TKey, TValue> tree, int index)
        {
            _tree = tree;
            _index = index;
        }
    ...
    public readonly struct ChildNodesCollection : IEnumerable<Node>
    {
        ...
        {
            private readonly ContiguousPrefixTreeDictionary<TKey, TValue> _tree;
            ...
            internal Enumerator(ContiguousPrefixTreeDictionary<TKey, TValue> tree, int firstSiblingIndex)
            {
                _tree = tree;
